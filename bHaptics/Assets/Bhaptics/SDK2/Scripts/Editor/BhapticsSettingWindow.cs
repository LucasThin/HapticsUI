...
namespace Bhaptics.SDK2
{
    public class BhapticsSettingWindow : EditorWindow
    {
        ...
        private static bool IsSortLastUpdated = true;
        ...
        private void OnEnable()
        {
            ...
            BhapticsLibrary.IsBhapticsAvailable();
        }
        ...
        {
            GUILayout.Space(4f);
            GUILayout.Label("Welcome to bHaptics SDK !", mainTapTitleStyle);
            ...
            GUILayout.Label("<color=#646464>It is recommended that you view the Guide documentation before you begin.</color>",
        ...
        private void ShowHapticEventsTap()
        {
            ...
            GUI.Label(new Rect(452f, 9f, 79f, 16f), "Last Updated", new GUIStyle(fontRegularStyle) { fontSize = 13 });
            GUILayout.Space(10f);
            ...
            GUI.Label(new Rect(567f, 9f, 79f, 16f), "A-Z", new GUIStyle(fontRegularStyle) { fontSize = 13 });
            GUILayout.EndHorizontal();
            GUILayout.EndVertical();
        ...
        private void DrawEventsButtonDetail(int index, MappingMetaData eventData)
        {
            ...
            string deviceString = "";
            for (int i = 0; i < eventData.positions.Length; ++i)
            {
                deviceString += eventData.positions[i] + "      ";
            }
